        ...
        <div className="container">
            <Flex direction="column" align="center">
                <Box
                    ...
                    mx="auto"
                    p="20px"
                    px={{ base: "20px", md: "40px" }} // Adiciona padding horizontal variável
                >
                    <Center mb="20px">
                        <div className="title">
                    ...
                    <Center mb="20px">
                        <Text as="p" color={'white'} opacity={0.8} fontSize={24}>
                            Conectando produtores Locais e Pernambucanos Conscientes
                        </Text>
                    </Center>
                    ...
                    <Box mb="20px">
                        <Text color={'white'} as="p">
                            Estamos sempre abertos a feedback, sugestões e parcerias. Se você deseja saber mais sobre o RecDaterra ou gostaria de se envolver de alguma forma, entre em contato conosco. Estamos ansiosos para ouvir de você!
                        </Text>
                    </Box>
                    ...
                    <Box>
                        <Text color={'white'} as="p">
                            Junte-se a nós nessa jornada rumo a um futuro mais sustentável e conectado com a terra. No RecDaterra, celebramos a diversidade da agricultura local, honramos as tradições do campo e trabalhamos juntos para construir uma comunidade mais forte e resiliente.
                        </Text>
                    </Box>
                </Box>
            </Flex>
