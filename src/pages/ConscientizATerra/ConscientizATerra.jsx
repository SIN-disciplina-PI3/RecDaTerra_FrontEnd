...
function ConscientizAterra() {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            setSlidesPerView(isSmallScreen ? 1 : 2);
    ...
    return (
        <div className="container">
            <Flex direction="column" align="center">
                <Center>
                    <div className="title">
                        <Text as="h1" ml="30px" mr="30px">ConscientizATerra</Text>
                    </div>
                </Center>
                <Center mb="20px" ml="30px" mr="30px">
                    <Text as="p" color={'white'} opacity={0.9} fontSize={14} maxW={700} textAlign={'justify'} mt={3}>
                        Aqui você vai encontrar as melhores informações, notícias, curiosidades e dicas sobre o mundo da sustentabilidade, 
                        agricultura, artesanato, nutrição, higiene, entre outras conhecimentos que ajudam a ConscientizAr a nossa Terra
                    </Text>
                </Center>
                    ...
                    >
                        <SwiperSlide style={{display: 'flex', justifyContent: 'center'}}>
                            <Box bg="#7ED957" color="white" p={4} borderRadius="20px" width="550px" height="530px" display="flex" flexDirection="column" alignItems="center" justifyContent="flex-start">
                                <Text textAlign="justify" mt={3} mb={8}>
                                    Segundo a <Text as="span" color={'#7A5448'} fontWeight={'bold'}>Agência Internacional de Energia Renovável (IRENA)</Text>, a instalação de painéis solares pode reduzir significativamente a pegada de carbono de uma casa ao longo do tempo.
                                </Text>
                                <Center>
                        ...
                        <SwiperSlide style={{display: 'flex', justifyContent: 'center'}}>
                            <Box bg="#7ED957" color="white" p={4} borderRadius="20px" width="550px" height="530px" display="flex" flexDirection="column" alignItems="center" justifyContent="flex-start">
                                <Text textAlign="justify" mt={3} mb={8}>
                                    <Text as="span" color={'#7A5448'} fontWeight={'bold'}>Prefeitura do Recife</Text> inaugura Econúcleo dedicado à educação ambiental na Lagoa do Araçá.
                                </Text>
                                <Center>
                        ...
                        <SwiperSlide style={{display: 'flex', justifyContent: 'center'}}>
                            <Box bg="#7ED957" color="white" p={4} borderRadius="20px" width="550px" height="530px" display="flex" flexDirection="column" alignItems="center" justifyContent="flex-start">
                                <Text textAlign="justify" mt={3} mb={8}>
                                    <Text as="span" color={'#7A5448'} fontWeight={'bold'}>Governo do Estado de Pernambuco</Text> promove ações para incentivar agricultores familiares no Estado
                                </Text>
                                <Center>
                        ...
                        <SwiperSlide style={{display: 'flex', justifyContent: 'center'}}>
                            <Box bg="#7ED957" color="white" p={4} borderRadius="20px" width="550px" height="530px" display="flex" flexDirection="column" alignItems="center" justifyContent="flex-start">
                                <Text textAlign="justify" mt={3} mb={8}>
                                    <Text as="span" color={'#7A5448'} fontWeight={'bold'}>13 Hbábitos Sustentáveis</Text> que ajudam o planeta e economizam dinheiro
                                </Text>
                                <Center>
                        ...
                        <SwiperSlide style={{display: 'flex', justifyContent: 'center'}}>
                            <Box bg="#7ED957" color="white" p={4} borderRadius="20px" width="550px" height="530px" display="flex" flexDirection="column" alignItems="center" justifyContent="flex-start">
                                <Text textAlign="justify" mt={3} mb={8}>
                                    <Text as="span" color={'#7A5448'} fontWeight={'bold'}>Os 12 Princípios da Limpeza Sustentável</Text> da RL Higiene
                                </Text>
                                <Center>
                        ...
                        <SwiperSlide style={{display: 'flex', justifyContent: 'center'}}>
                            <Box bg="#7ED957" color="white" p={4} borderRadius="20px" width="550px" height="530px" display="flex" flexDirection="column" alignItems="center" justifyContent="flex-start">
                                <Text textAlign="justify" mt={3} mb={8}>
                                    <Text as="span" color={'#7A5448'} fontWeight={'bold'}>Recife</Text> é a melhor capital do Nordeste em desenvolvimento sustentável
                                </Text>
                                <Center>
